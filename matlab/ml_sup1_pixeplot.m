...
% Load mat files
data_outer = load('~/Desktop/rosbags/june_27/pixel_data/test8nibvs_data_outer.mat');
data_inner = load('~/Desktop/rosbags/june_27/pixel_data/test8nibvs_data_inner.mat');
